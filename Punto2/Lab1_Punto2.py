...
# Title: Lab1_Punto2
# Author: Minuk_Lee_Santiago_Rodriguez_G3_B1A
...
class Lab1_Punto2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab1_Punto2", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_Punto2")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Lab1_Punto2")
